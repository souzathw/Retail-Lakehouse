...
EXPECTED_GOLD_COLUMNS: List[str] = [
    ...
    "total_reorders",
    "distinct_users",
    "distinct_reordering_users",
    "distinct_orders",
    "distinct_reorder_orders",
    "reorder_rate",
    "gold_processed_at",
]
...
def validate_gold_repurchase_metrics() -> None:
    print("==================================================")
    print("Retail Lakehouse - Validação Gold repurchase_metrics")
    print("==================================================")

    gold_base_dir = resolve_gold_base_dir()
    entity_dir = gold_base_dir / "instacart" / "repurchase_metrics"
    ...
    print("==================================================")
    print("Resultado da validação Gold repurchase_metrics")
    print("==================================================")
    ...
    if row_count == 0:
        errors.append("A Gold de repurchase_metrics está vazia no arquivo analisado.")

    if missing_columns:
        errors.append(
            f"Colunas ausentes na Gold de repurchase_metrics: {missing_columns}"
        )
    ...
    if errors:
        ...
        for error in errors:
            print(f"- {error}")
        raise ValueError("Validação da Gold de repurchase_metrics falhou.")

    print("[OK] Validação da Gold de repurchase_metrics concluída com sucesso.")