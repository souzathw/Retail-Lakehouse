...
def validate_silver_order_items_train_enriched() -> None:
    print("==================================================")
    print("Retail Lakehouse - Validação Silver order_items_train_enriched")
    print("==================================================")

    silver_base_dir = resolve_silver_base_dir()
    entity_dir = silver_base_dir / "instacart" / "order_items_train_enriched"
    ...
    print("==================================================")
    print("Resultado da validação Silver order_items_train_enriched")
    print("==================================================")
    ...
    if row_count == 0:
        errors.append(
            "A Silver de order_items_train_enriched está vazia no arquivo analisado."
        )

    if missing_columns:
        errors.append(
            "Colunas ausentes na Silver de order_items_train_enriched: "
            f"{missing_columns}"
        )
    ...
    if errors:
        ...
        for error in errors:
            print(f"- {error}")
        raise ValueError("Validação da Silver de order_items_train_enriched falhou.")

    print("[OK] Validação da Silver de order_items_train_enriched concluída com sucesso.")