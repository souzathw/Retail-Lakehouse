...
def validate_bronze_products() -> None:
    print("==================================================")
    print("Retail Lakehouse - Validação Bronze products")
    print("==================================================")

    bronze_base_dir = resolve_bronze_base_dir()
    entity_dir = bronze_base_dir / "instacart" / "products"
    ...
    print("==================================================")
    print("Resultado da validação Bronze products")
    print("==================================================")
    ...
    if row_count == 0:
        errors.append("A Bronze de products está vazia.")

    if missing_columns:
        errors.append(f"Colunas ausentes na Bronze de products: {missing_columns}")

    if errors:
        print("Erros encontrados:")
        for error in errors:
            print(f"- {error}")
        raise ValueError("Validação da Bronze de products falhou.")

    print("[OK] Validação da Bronze de products concluída com sucesso.")
