...
def validate_bronze_aisles() -> None:
    print("==================================================")
    print("Retail Lakehouse - Validação Bronze aisles")
    print("==================================================")

    bronze_base_dir = resolve_bronze_base_dir()
    entity_dir = bronze_base_dir / "instacart" / "aisles"
    ...
    print("==================================================")
    print("Resultado da validação Bronze aisles")
    print("==================================================")
    ...
    if row_count == 0:
        errors.append("A Bronze de aisles está vazia.")

    if missing_columns:
        errors.append(f"Colunas ausentes na Bronze de aisles: {missing_columns}")

    if errors:
        print("Erros encontrados:")
        for error in errors:
            print(f"- {error}")
        raise ValueError("Validação da Bronze de aisles falhou.")

    print("[OK] Validação da Bronze de aisles concluída com sucesso.")
