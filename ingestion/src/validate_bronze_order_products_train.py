...
def validate_bronze_order_products_train() -> None:
    print("==================================================")
    print("Retail Lakehouse - Validação Bronze order_products_train")
    print("==================================================")

    bronze_base_dir = resolve_bronze_base_dir()
    entity_dir = bronze_base_dir / "instacart" / "order_products_train"
    ...
    print("==================================================")
    print("Resultado da validação Bronze order_products_train")
    print("==================================================")
    ...
    if row_count == 0:
        errors.append("A Bronze de order_products_train está vazia.")

    if missing_columns:
        errors.append(
            f"Colunas ausentes na Bronze de order_products_train: {missing_columns}"
        )
    ...
    if errors:
        ...
        for error in errors:
            print(f"- {error}")
        raise ValueError("Validação da Bronze de order_products_train falhou.")

    print("[OK] Validação da Bronze de order_products_train concluída com sucesso.")
